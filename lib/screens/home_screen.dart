          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                RoundedButton(color: Colors.blueAccent, textColor: Colors.white,title: 'BẮT ĐẦU',function: (){}),
                const SizedBox(height: 10,),
                Text('"Em có biết tại sao lá cây lại màu xanh"',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                  color: Colors.blue[900]
                ),),
                Text('-Câu châm ngôn gì đó-',
                style: TextStyle(fontSize: 16,color: Colors.blue[900]),),
                const SizedBox(height: 20,),
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 88),
                  child: Material(
                    color: Colors.white,
                    elevation: 5,
